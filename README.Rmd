...
newsrivr is a R wrapper to the [Newsriver API](https://newsriver.io/), providing simple functions to retrieve and clean news articles following a tidy framework. The Newsriver API is free for non-commercial purposes, and when combined with newsrivr, can return over 350,000 articles in a single call.
